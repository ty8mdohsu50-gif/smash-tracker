export default {
  ...
  matchupNotes: {
    ...
    neutral: "立ち回り",
    neutralPlaceholder: "間合い管理、牽制技、注意点...",
    advantage: "有利状況",
    advantagePlaceholder: "コンボ、着地狩り、崖上がり狩り...",
    disadvantage: "不利状況",
    ...
    nextHypothesis: "次回の仮説",
    nextHypothesisPlaceholder: "次回検証したいこと...",
    prevHypothesis: "前回の仮説",
    reviewNeeded: "要復習",
    tendencyMemo: "癖メモ",
