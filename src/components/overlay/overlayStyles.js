...
export const DIM_TEXT = "rgba(255,255,255,0.55)";
export const MUTED_TEXT = "rgba(255,255,255,0.75)";

export const OVERLAY_FONT = "'Chakra Petch', 'Noto Sans JP', sans-serif";

export const bgColor = (bgOpacity) => `rgba(12, 12, 24, ${Math.max(0, Math.min(100, bgOpacity)) / 100})`;
...
export const panelStyle = ({ bg, accent, flashState, borderRadius = 14 }) => ({
